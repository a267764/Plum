    ...
    class Poetry(
        ...
        */
        ...
        """.trimIndent(),
                    ...
                    it.authorIntroduction = "张若虚（生卒年不详，但有些典籍推算约660—约720），唐代诗人。汉族，扬州（今属江苏扬州）人。曾任兖州兵曹。生卒年、字号均不详。事迹略见于《旧唐书·贺知章传》。中宗神龙（705～707）中，与贺知章、贺朝、万齐融、邢巨、包融俱以文词俊秀驰名于京都，与贺知章、张旭、包融并称“吴中四士”。玄宗开元时尚在世。张若虚的诗仅存二首于《全唐诗》中。其中《春江花月夜》是一篇脍炙人口的名作，它沿用陈隋乐府旧题，抒写真挚动人的离情别绪及富有哲理意味的人生感慨，语言清新优美，韵律宛转悠扬，洗去了宫体诗的浓脂艳粉，给人以澄澈空明、清丽自然的感觉。"
                    it.note = """
        1. 滟（yàn）滟：波光荡漾的样子。
